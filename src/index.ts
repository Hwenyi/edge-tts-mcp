...
server.tool(
  "speech_text_aloud",
  "generate lifelike audio from text, and having it read aloud. If there are no special requirements for emotions and tones, pitch and other options remain default",
